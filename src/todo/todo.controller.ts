...
export class TodoController {
  ...
  @ApiOperation({ description: 'To add a new task w.r.t the user email.', summary: 'Add a new task.' })
  @Post()
  ...
  @ApiBearerAuth()
  @UseGuards(JwtAuthGuard)
  @ApiOperation({ description: 'To get a specifi user task.', summary: 'To get a specific user task.' })
  @Get(':id')
